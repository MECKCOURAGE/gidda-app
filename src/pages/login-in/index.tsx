...
const Login = () => {
  ...
  return (
    <div className="mx-auto flex min-h-screen w-full gap-[60px] xl:px-0">
      ...
      <div
        className="flex w-full flex-1 flex-col bg-cover bg-bottom bg-no-repeat pb-8 pt-6 md:px-[20px] lg:justify-center"
      >
        ...
        <div className="max-w-[500px]">
          <div className="w-full">
            ...
            >
              ...
              <div className="text-red-700 text-[15px] font-millik mx-auto uppercase">{errorMessage}</div>
              ...
              <div className="flex flex-col">
                ...
                <h4 className="uppercase text-green font-redhat mt-[50px] font-extrabold ml-[20px]"><Link to="/home">back to home page</Link></h4>
