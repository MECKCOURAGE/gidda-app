  ...
  return (
    <div className="">
      ...
      <div className="flex md:justify-center ">
        <div className="flex sm:rounded-[40px] border-2  ml-4 border-green">
          <div className="border-r-2 border-green sm:rounded-l-[40px] bg-secondary-gradient-alt p-[10px] md-[10px] xl:p-[20px] flex flex-col  space-y-4">
            <img src={Chima} className=" w-[175px] md:w-[206px] md:h-[207px] rounded-[16px]" />
            <h1 className="font-redhat font-semibold text-[20px] md:text-[24px] leading-[24px] text-black">
              Chima Okereke
            </h1>
...
const Block = () => {
  return (
    <div className="flex flex-col items-center mx-[35px] md:ml-[60px] my-auto">
      <div className="md:w-[57px] w-[40px] h-[40px] md:h-[57px] rounded-full bg-green text-neutralWhite flex items-center justify-center">
        1
      </div>

      <div className="w-[2px] h-[85px] bg-green bg-[linear-gradient(to_bottom,_#335F32_65%,_#D9D9D9_35%)]"></div>
      <div className="md:w-[57px] w-[40px] h-[40px] md:h-[57px] rounded-full bg-midGray flex items-center justify-center"></div>

      <div className="w-[2px] h-[85px] bg-midGray"></div>

      <div className="md:w-[57px] w-[40px] h-[40px] md:h-[57px] rounded-full bg-midGray flex items-center justify-center">
